...
export const Route = createFileRoute("/")({
  head: () => ({
      meta: [
      { title: "Overview — Vela Analytics" },
      { name: "description", content: "Unified analytics across all of Vela's social media channels." },
    ],
  }),
  component: Overview,
});
      ...
      <section className="relative overflow-hidden rounded-3xl bg-glass p-8 shadow-card-elevated">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            >
              The pulse of <span className="text-gradient">Vela</span> across every channel.
            </motion.h1>
            <motion.p
